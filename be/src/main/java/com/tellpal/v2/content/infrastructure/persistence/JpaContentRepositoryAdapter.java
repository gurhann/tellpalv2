...
public class JpaContentRepositoryAdapter implements ContentRepository {
    ...
    @Override
    public Optional<Content> findByIdForInstrumentWrite(Long id) {
        return repository.findByIdForInstrumentWrite(id);
    }
    ...
    @Override
    public List<ContributorUsage> findContributorUsage(Collection<Long> contributorIds) {
        return repository.findContributorUsage(contributorIds);
    }
