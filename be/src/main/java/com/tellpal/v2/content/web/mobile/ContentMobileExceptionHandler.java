...
@RestControllerAdvice(basePackageClasses = ContentMobileController.class)
public class ContentMobileExceptionHandler {

    @ExceptionHandler(MobileContentNotFoundException.class)
    ProblemDetail handleContentNotFound(MobileContentNotFoundException exception, HttpServletRequest request) {
        return create(HttpStatus.NOT_FOUND, "Content not found", exception.getMessage(), "content_not_found", request);
    }
