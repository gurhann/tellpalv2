...
export const enMessages = {
  ...
  "nav.localTools": "Local tools",
  "nav.mockups.label": "Mockups",
  "nav.mockups.description": "Clickable UI review routes.",
  ...
  "contributors.panel.edit": "Edit contributor assignment",
  "contributors.panel.reorderError":
    "The order could not be saved. The previous order was restored.",
  "contributors.edit.title": "Edit contributor assignment",
  "contributors.edit.description":
    "Update the credit role, language scope, or display name for this content.",
  "contributors.edit.identityHint": "The contributor identity stays unchanged.",
  "contributors.edit.role": "Role",
  "contributors.edit.scope": "Credit scope",
  "contributors.edit.creditName": "Credit name",
  "contributors.edit.cancel": "Cancel",
  "contributors.edit.save": "Save assignment",
  "contributors.edit.pending": "Saving assignment...",
  "contributors.edit.success": "Contributor assignment updated.",
  "contributors.edit.errorTitle": "Contributor assignment update failed",
  "contributors.edit.error": "The contributor assignment could not be updated.",
...
export const trMessages = {
  ...
  "nav.localTools": "Yerel araçlar",
  "nav.mockups.label": "Mockup’lar",
  "nav.mockups.description": "Tıklanabilir arayüz inceleme rotaları.",
  ...
  "contributors.panel.edit": "Katkıda bulunan atamasını düzenle",
  "contributors.panel.reorderError":
    "Sıra kaydedilemedi. Önceki sıra geri yüklendi.",
  "contributors.edit.title": "Katkıda bulunan atamasını düzenle",
  "contributors.edit.description":
    "Bu içerik için kredi rolünü, dil kapsamını veya görünen kredi adını güncelleyin.",
  "contributors.edit.identityHint": "Katkıda bulunan kimliği değişmeden kalır.",
  "contributors.edit.role": "Rol",
  "contributors.edit.scope": "Kredi kapsamı",
  "contributors.edit.creditName": "Kredi adı",
  "contributors.edit.cancel": "İptal",
  "contributors.edit.save": "Atamayı kaydet",
  "contributors.edit.pending": "Atama kaydediliyor...",
  "contributors.edit.success": "Katkıda bulunan ataması güncellendi.",
  "contributors.edit.errorTitle": "Katkıda bulunan ataması güncellenemedi",
  "contributors.edit.error": "Katkıda bulunan ataması güncellenemedi.",
