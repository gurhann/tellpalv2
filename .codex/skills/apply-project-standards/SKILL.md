...
1. Read `AGENTS.md`.
2. Read `be/docs/project-memory.md` if it exists.
3. Read relevant ADRs under `be/docs/adr/`.
...
3. If the task changes a durable engineering decision, update `be/docs/project-memory.md`.
